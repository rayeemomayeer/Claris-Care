...
const Navbar = () => {
  ...
  return (
    <nav className="px-4 flex justify-around align-center navbar" style={{backgroundColor: '#00E1CE'}}>
      ...
      <div className="">
          ...
          <NavLink activeStyle={{fontWeight: "bold"}}  className="px-2 text-2xl font-medium no-underline text-white" to="/contract">Contract</NavLink>
      ...
      <div className="flex align-middle">
        ...
        <img className="w-12 h-12 ml-3 rounded-3xl" src={user?.photoURL?user.photoURL:'https://i1.wp.com/researchictafrica.net/wp/wp-content/uploads/2016/10/default-profile-pic.jpg?ssl=1'} alt="" />
        {
          user?.email?
            ...
            <NavLink className="no-underline font-medium text-xl rounded-3xl bg-purple-500 hover:bg-purple-600 text-white px-4 py-2 mx-2" to="/login">SIGN UP</NavLink>
        }
      </div>
    </nav>
  );
